...
describe("lexer", () => {
  ...
  it('World English Bible Extracts', () => {
    ...
    expect(Array.from(lexer(text))).to.deep.equal([
      ...
      { kind: 'ide',           data: 'UTF-8'},
      { kind: 'h',             text: 'Genesis' },
      { kind: 'toc', level: { is_range: false, value: 1 }, text: 'The First Book of Moses, Commonly Called Genesis' },
      { kind: 'toc', level: { is_range: false, value: 2 }, text: 'Genesis' },
      { kind: 'toc', level: { is_range: false, value: 3 }, text: 'Genesis' },
      { kind: 'mt',  level: { is_range: false, value: 2 }, text: 'The First Book of Moses,' },
      { kind: 'mt',  level: { is_range: false, value: 3 }, text: 'Commonly Called' },
      { kind: 'mt',  level: { is_range: false, value: 1 }, text: 'Genesis' },
      { kind: 'c', data: '1' },
      { kind: 'p' },
    ...
    expect(Array.from(lexer(text))).to.deep.equal([
      ...
      { kind: "q", level: { is_range: false, value: 1 },   text: "“Because you have done this," },
      { kind: "q", level: { is_range: false, value: 2 },   text: "you are cursed above all livestock," },
      { kind: "q", level: { is_range: false, value: 2 },   text: "and above every animal of the field." },
      { kind: "q", level: { is_range: false, value: 1 },   text: "You shall go on your belly" },
      { kind: "q", level: { is_range: false, value: 2 },   text: "and you shall eat dust all the days of your life." },
      { kind: "q", level: { is_range: false, value: 1 } },
      { kind: "v", data: '15', text: "I will put hostility between you and the woman," },
      { kind: "q", level: { is_range: false, value: 2 },   text: "and between your offspring and her offspring." },
      { kind: "q", level: { is_range: false, value: 1 },   text: "He will bruise your head," },
      { kind: "q", level: { is_range: false, value: 2 },   text: "and you will bruise his heel.”" },
      { kind: "p" },
      { kind: "v", data: '16', text: "To the woman he said," },
      { kind: "q", level: { is_range: false, value: 1 },   text: "“I will greatly multiply your pain in childbirth." },
      { kind: "q", level: { is_range: false, value: 2 },   text: "You will bear children in pain." },
      { kind: "q", level: { is_range: false, value: 1 },   text: "Your desire will be for your husband," },
      { kind: "q", level: { is_range: false, value: 2 },   text: "and he will rule over you.”" },
    ]);
    ...
    expect(Array.from(lexer(text))).to.deep.equal([
      ...
      { kind: 'q',  level: { is_range: false, value: 2 }, text: 'poverty and riches, are from the Lord.' },
      { kind: 'v',  data: '15-16' },
      { kind: 'f',  data: '+' },
      ...
      { kind: 'q',  level: { is_range: false, value: 2 }, text: 'His good pleasure will prosper forever.' },
    ]);
  });
